...
<div class="mst-modal-inner">
    ...
    <div class="mst-modal-body" style="padding: 40px; max-height: 70vh; overflow-y: auto;">
        <div class="mst-ticket-view" style="text-align: center;">
            <!-- QR КОД -->
            <div class="mst-ticket-qr" style="width: 220px; height: 220px; margin: 0 auto 30px; background: linear-gradient(135deg, #f0f0f0 0%, #e0e0e0 100%); border-radius: 16px; display: flex; align-items: center; justify-content: center; border: 3px solid #9952E0; box-shadow: 0 8px 24px #966ebdff;">
                <?php
                // Генерация QR кода
